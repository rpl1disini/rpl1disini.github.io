...
/*****************************************************************************
	CSS3 ANIMATIONS
*****************************************************************************/
	jQuery('.fade-in-intro').appear(function() {
		$('.fade-in-intro').each(function(){
	...
	jQuery('.slideLeft').appear(function() {
...
marker:{
values:[
{latLng:[14.581,-90.495],options:{icon:"img/iconomapa.png"}}
],
options:{
draggable: false
}
...
/*****************************************************************************
	PIE CHART - ADD YOUR PERCENTAGES & CHANGE COLOUR HERE
******************************************************************************/
...
jQuery('.chart1').appear(function() {
    //create instance
    $('.chart1').easyPieChart({
        animate: 1000, barColor:"#3bb3e0"
	});
setTimeout(function() {
        $('.chart1').data('easyPieChart').update(100);
    }, 1000);
});
...
jQuery('.chart3').appear(function() {
    ...
    setTimeout(function() {
        $('.chart3').data('easyPieChart').update(100);
    }, 1000);
	});
});
...
/*****************************************************************************
	MILESTONE COUNTERSS - ADD YOUR PERCENTAGES HERE
******************************************************************************/
